...
#             # 0:No, 1:Yes, 2:Ask for each renaming
    ("main", "wikiWord_renameDefault_modifyWikiLinks"): "advanced", # When renaming wiki word, should it try to rename links to the word, too?
...
#     ("main", "tempFiles_inWikiDir"): "False",  # Store temp. files in wiki dir instead of normal temp dir.?
    ...
    ("main", "userEvent_mouse/leftdoubleclick/pagetab"): "action/none",  # How to react on left double click on tab?
