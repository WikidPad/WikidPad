...
class WikiTxtCtrl(wxStyledTextCtrl):
    ...
    def rewrapText(self):
        ...
        if (startLine <= endLine):
            ...
            startLineStr = self.GetLine(startLine)
            if WikiFormatting.BulletRE.match(startLineStr) or WikiFormatting.NumericBulletRE.match(startLineStr):                
                subIndent = indent + 2
    ...
    def OnCharAdded(self, evt):
        ...
        if key == 10:
            ...
            if currentLine > 0:
                ...
                elif WikiFormatting.NumericBulletRE.search(previousLine):
                    self.AddText("%s# " % (" " * self.GetLineIndentation(currentLine-1)))
    ...
    def OnMouseMove(self, evt):
        ...
        if self.isPositionInWikiWord(linkPos) or self.isPositionInLink(linkPos):
