...
class WikiTxtCtrl(SearchableScintillaControl):
    ...
    SUGGESTION_CMD_IDS = [GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_0.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_1.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_2.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_3.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_4.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_5.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_6.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_7.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_8.GetId(),
            GUI_ID.CMD_REPLACE_THIS_SPELLING_WITH_SUGGESTION_9.GetId()]
