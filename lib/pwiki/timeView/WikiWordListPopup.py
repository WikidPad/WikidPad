...
from pwiki.Configuration import MIDDLE_MOUSE_CONFIG_TO_TABMODE, isWindows
...
#         self._listMinWidth = 60
        ...
        setWindowClientSize(self, (rect.x + rect.width + 2,
...
# This variant crashes under Windows

# class WikiWordListPopup(wx.PopupWindow):
#     """
#     Popup window which appears when hovering over a particular date
#     Using frame because wx.PopupWindow is not available on Mac OS
#     """
...
#             ID = GUI_ID.TIMESHOW_WIKIWORDLIST_POPUP
# 
#         wx.PopupWindow.__init__(self, parent, ID)  # flags=wx.BORDER_NONE
#         
#         self.Position(pos, wx.Size(20, 20))
#         
#         
# #         , "WikiWordList", pos=pos,
# #                 style=wx.FRAME_FLOAT_ON_PARENT | self.FRAME_BORDER |     
# #                 wx.FRAME_NO_TASKBAR)     # wx.RESIZE_BORDER | 
# 
#         self.mainControl = mainControl
...
#         
#         self.updateList()
#         self.resultBox.Layout()
#         
# #         print "--WikiWordListPopup34", repr((sizer.GetSize(), sizer.GetMinSize()))
#         
#         # Calculate size
#         rect = self.resultBox.GetItemRect(0)
#         
#         print "--WikiWordListPopup39", repr(rect)
#         self.resultBox.SetSize((rect.x + rect.width,
#                 rect.y + rect.height * len(self.listContent)))
#         
#         setWindowClientSize(self, (rect.x + rect.width + 2,
#                 rect.y + 2 + rect.height * len(self.listContent)))
#                 
# #         sz = self.resultBox.GetBestSize()
