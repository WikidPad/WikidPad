...
AppName=WikidPad
AppVerName=WikidPad 2.0rc07
DefaultDirName={pf}\WikidPad
DefaultGroupName=WikidPad
AppID={{22A83C29-58A8-4CAB-8EDC-918D74F8429E}
VersionInfoVersion=002.000.207.000
VersionInfoTextVersion=WikidPad 2.0rc07
LicenseFile=C:\DATEN\Projekte\Wikidpad\Current\license.txt
AllowNoIcons=true
ShowLanguageDialog=yes
Compression=lzma/ultra
OutputBaseFilename=WikidPad-2.0rc07
InternalCompressLevel=ultra
AppCopyright=© 2005-2010 Jason Horman, Michael Butscher, Gerhard Reitmayr
UsePreviousAppDir=true
PrivilegesRequired=none
[INI]
Filename: {app}\binInst.ini; Section: Main; Key: CurrVersion; String: 002.000.207.000; Flags: createkeyifdoesntexist uninsdeleteentry uninsdeletesectionifempty
